    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 py-20">
        <motion.p
          ...
          className="font-sans text-xs md:text-sm tracking-[0.4em] uppercase text-primary mb-8 font-bold"
        >
        ...
        >
          <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-medium text-foreground/80 leading-tight">
            <span className="block">Sara</span>
            <span className="font-body italic text-3xl md:text-4xl lg:text-5xl text-primary my-2 block">
              &
            </span>
        ...
        >
          <div className="inline-flex items-center gap-4">
            ...
            <p className="font-body text-xl md:text-2xl text-foreground tracking-wide font-bold">
              9 de Maio de 2026
            </p>
            <div className="w-16 h-px bg-primary/40" />
          </div>
          <p className="font-sans text-xs md:text-sm tracking-[0.3em] uppercase text-muted-foreground mt-4 font-bold">
            Campo Grande, MS
          </p>
        </motion.div>
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <img
          src={dividerImage}
          alt=""
          className="w-full h-12 object-cover opacity-40"
        />
      </div>
    </section>
  );
